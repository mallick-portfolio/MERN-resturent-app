...
const UpdateFood = () => {
  ...
  const { id } = useParams();
  useEffect(() => {
    axios(`http://localhost:5000/foods/${id}`).then((res) => {
      ...
      <Form onSubmit={handleSubmit(onSubmit)} className="row">
        <div className="col-md-6 col-sm-12">
          <FloatingLabel
            ...
            className="mb-3"
          >
            <Form.Control {...register("title")} value={food.title} />
          </FloatingLabel>
        </div>
        <div className="col-md-6 col-sm-12">
          <FloatingLabel
            ...
            className="mb-3"
          >
            <Form.Control {...register("image")} value={food.image} />
          </FloatingLabel>
        </div>
        <div className="col-md-6 col-sm-12">
        ...
        <div className="col-md-6 col-sm-12">
          ...
          <Form.Select {...register("category")} value={food.category}>
